    ...
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.card}>
          ...
          <p className={styles.text}>⭐ Director o directora: Christopher Nolan, Greta Gerwig, Bong Joon-ho…</p>
          <p className={styles.text}>⭐ Actor/Actriz: Leonardo DiCaprio, Zendaya, Keanu Reeves… </p>
            <p className={styles.text}>⭐ Franquicia o saga: Marvel, Star Wars, Harry Potter…</p>
          
        </div>
        <div className={styles.card}>
          <h2 className={styles.subtitle}>🔴 Calidad</h2>
          <p className={styles.text}>⭐ Popularidad: más vistas, recomendadas por críticos, tendencia actual
          </p>
        </div>
        <div className={styles.card}>
          <h2 className={styles.subtitle}>🔴 Ejemplos de Busqueda</h2>
          <p className={styles.text}>⭐ "Películas de ciencia ficción de los 90 con buena crítica"</p>
          <p className={styles.text}>⭐ "Comedias románticas con menos de 100 minutos y en español"</p>
          <p className={styles.text}>⭐ "Películas coreanas de crimen recomendadas por críticos"</p>
          <p className={styles.text}>⭐ "Documentales históricos ganadores del Oscar"</p>
        </div>
      </section>
    </div>
  )
